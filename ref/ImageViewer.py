...
class ImageViewer(Frame):
    ...
    def __init__(self, master, pixInfo, resultWin):
        ...
        self.submit_relevant = Button(controlFrame, text="Submit relevant", padx=10, width=20,
                                      command=lambda: self.find_distance(method="relevance_method"))
    ...
    def update_weights_procedure(self):
        ...
        # relevant_list.insert(0, query_img_number) # insert at index 0
        return pixInfo.update_weights(relevant_imgs=relevant_list)
    #
